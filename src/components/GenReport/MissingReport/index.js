...
function MissingReport(props) {
    ...
    useEffect(() => {
        Axios.get("https://kebonematimela.herokuapp.com/api/get_all_lost_livestock").then((response) => {
